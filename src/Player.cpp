...
void Player::update() {
	...
	if(DEATH_ANIMATION) {
		p1Renderer->addCenterRotatedTile(&flame, pos.x, pos.y,-1, F_NONE, F_VERT, flame_rotation, NULL, 255, 255, 255, 255);
	}

	if(FACING_RIGHT) {
		p1Renderer->addCenterRotatedTile(&anim, pos.x, pos.y,-1, F_HORIZ, F_VERT, player_rotation, NULL, 255, 255, 255, 255);
	} else {
		p1Renderer->addCenterRotatedTile(&anim, pos.x, pos.y,-1, F_NONE, F_VERT, player_rotation, NULL, 255, 255, 255, 255);
	}
}
